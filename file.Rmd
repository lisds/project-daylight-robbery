...
The dataframe above shows the values in the borough columns for the `borough` and `ward` datasets. As you can see here, there are 33 boroughs in each of the data frames, instead of 32.
